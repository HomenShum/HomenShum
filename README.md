...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Homen%20Shum-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/homen-shum/)
[![NodeBench](https://img.shields.io/badge/NodeBench-entity%20research%20workspace-111827?style=flat-square)](https://github.com/HomenShum/nodebench-ai)
[![MCP](https://img.shields.io/badge/MCP-tool%20systems-5B5CF6?style=flat-square)](https://github.com/HomenShum/nodebench-ai)
...
```mermaid
flowchart LR
  inputs["Messy inputs<br/>email, docs, screenshots, companies, roles"] --> structure["Structured state<br/>entities, claims, lanes, tasks, rubrics"]
  structure --> agents["Agent workflows<br/>tools, memory, MCP, runtime sessions"]
  agents --> verification["Verification<br/>evals, screenshots, changelogs, sourced evidence"]
  verification --> products["Usable products<br/>research workspace, Gmail command center, UI parity tools"]

  finance["Finance + risk background"] --> structure
  healthcare["Healthcare ops automation"] --> products
  builders["Coding agents + dev tools"] --> verification
```
